...
1. **Provide backup if needed**. If you plan to be out (e.g. [vacation](/handbook/people-group/time-off-and-absence/time-off-types/), [company business](/handbook/finance/travel/), [events](https://about.gitlab.com/events/), etc.) during a new GitLab team-member's first few weeks, please ensure that a backup onboarding buddy is available to offer support.
...
<details markdown="1">
<summary>Example Email Template</summary>
...
That's all there is to it! Thanks for your help welcoming the newest GitLab team-member to the team and getting them on board. If you have questions that are not answered on this page, please reach out to the People Operations Team via the onboarding issue or HelpLab.
