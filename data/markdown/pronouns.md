...
Part of creating an inclusive, respectful workplace is paying attention to
[the language that we use](/handbook/values/#inclusive-language--pronouns) with each other, including how we use and share pronouns. Our inclusive language guidance is one way we put these values into practice.
...
A [pronoun](https://en.wikipedia.org/wiki/Pronoun) is a word (or group of words) that can take the place of a noun or noun phrase. We use pronouns all the time in everyday conversation.
For example:
...
You might have heard that **"they"** can only be used as a plural pronoun, but [singular they](https://en.wikipedia.org/wiki/Singular_they) has been part of English for centuries. It is widely accepted in modern usage and is an important way for many people to express their gender identity.
...
If you’re unsure whether singular "they" is acceptable, it is helpful to know that many [guides](https://www.grammarly.com/blog/parts-of-speech/use-the-singular-they/), dictionaries, and organizations recognize and support it.
...
Some people do not identify with pronouns like she/her, he/him, or they/them. They may use [Neopronouns](https://pronouns.org/neopronouns), which are pronouns beyond the most commonly used sets in English.
Examples of neopronouns include (but are not limited to):
...
You can add your GitLab.com pronouns on your [GitLab profile](https://docs.gitlab.com/ee/user/profile/#add-your-gender-pronouns).

Your pronouns might be visible in places like your profile and certain UI elements, depending on configuration.

### Google Mail (Gmail)

You can add your pronouns in your [email signature](https://support.google.com/mail/answer/8395). This can be especially helpful when communicating externally.

### Slack

You can add your Slack pronouns on your [Slack profile](https://slack.com/help/articles/204092246-Edit-your-profile).

Team members may also choose to include pronouns in their display name or custom fields, depending on workspace settings.

### Zoom

You can add your Zoom pronouns through the [Zoom web portal](https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0066454#h_01F89H5DCX04A6QG8Q3MS69Q4J).
