...
1. Create a [relocation issue](https://gitlab.com/gitlab-com/people-group/people-operations/employment-templates/-/blob/main/.gitlab/issue_templates/relocations.md) for the team member using the applicable country template in the [team member epics](https://gitlab.com/gitlab-com/team-member-epics/employment/-/issues) and assign to yourself and the relocating team member. Ensure all tasks are completed and follow up with the relocating team member if required.
    ...
    - Complete any Country Specific Tasks
...
The steps our People Operations Team member team uses to support relocations to the Netherlands in addition to above relocation process:
...
1. Once the relocation has been approved, the People Operations Specialist asks the relocating team member in their HelpLab case:

- “Hi NAME, 

Please select your [Provident Fund contribution](/handbook/entity/india-pvt-ltd/#provident-fund-and-national-pension-scheme) election:

- Uncapped percentage-based: 12% of basic salary per month
OR
- Capped amount: 1800 INR per month

If you would like to enroll in the [National Pension Scheme](/handbook/entity/india-pvt-ltd/#national-pension-scheme), please [submit your PRAN via this form](https://docs.google.com/forms/d/e/1FAIpQLSeW3X3yNMuGIdb-reaxzr7XuZ7kDrxNbwMaF2Xu7RYGtneIPg/viewform)."
...
1. When the relocation is entered in Workday, the workspace (Karnataka) and (if applicable) the provident fund allowance and NPS Contribution Rate will need to get updated.
...
"Provident Fund (INR)" if capped OR
"Provident Fund (%)" if uncapped

- Note: Further Provident Fund fields will pre-populate and must not be changed

1. To add the Voluntary NPS Contribution rate (if applicable), select 'Add Plan Assignment' again > Select 'Compensation Plan Type': Allowance > Select 'Voluntary NPS Contribution' > Once done, click OK

- Review the National Pension Scheme (NPS) Enrollment Acknowledgement form attached to the offer letter in the team member's contract folder in Workday

- Update the 'Percent' field in Workday with the team member's selected 'Employee NPS Contribution Rate' > click OK again and submit
