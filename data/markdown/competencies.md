...
Instead of maintaining separate materials they should link back to the most relevant place where the competency is defined. For general competencies, this is likely our [values](/handbook/values/) page. For role specific competencies, this is likely the [job-description-library](/handbook/hiring/job-description-library/#format) page.
For example, we should have one SSoT for how to articulate the value of GitLab.

1. [Job description requirements](/handbook/hiring/job-description-library/#format)
1. [Interview scoring](/handbook/hiring)
