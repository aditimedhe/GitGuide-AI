...
The DRI for individual team member contracts (once a team member is hired) is the People Operations Team. Any queries about a team member's contract should go to the People Operations Team by HelpLab ticket, and the query will be directed or escalated as appropriate.

**Approved changes or edits to the contract templates will be flagged to the CES team**

The Director, Talent Brand & Talent Acquisition Enablement will support a review to ensure all Greenhouse tokens are correct before an updated version of the template can be added to Greenhouse for use.
