...
- Demonstrating our commitment to sustainable, [efficient](/handbook/values/#efficiency) and results-focused performance
...
At GitLab, we measure [impact, not activity](/teamops/measurement-clarity/#measure-impact-not-activity). Our approach to time away reflects this fundamental value:
...
- **Public holidays** – we encourage all team members to use their public holiday balance, and as a company that values [Diversity, Inclusion & Belonging](/handbook/values/#values-competencies), team members have the flexibility to elect different dates and celebrate what’s important to them.
...
- **Community involvement** is valued – whether [volunteering](/handbook/people-group/givelab-volunteer-initiatives/), voting, or supporting causes aligned with GitLab's values.
...
- **Return with intention and insights** – When returning from time away, resist the urge to immediately catch up on all messages. Instead, begin by applying any reflections or insights gained during your break to high-impact work. [This approach](/handbook/company/culture/all-remote/mental-health/#rest-and-time-off-are-productive), articulated by John Fitch—working on your projects before working in them—allows you to make meaningful contributions while managing the natural adjustment period. Consider blocking time for strategic thinking or creative work before diving into tactical responses.
- **Reconnect intentionally** – Schedule informal [coffee chats](/handbook/company/culture/all-remote/informal-communication/#coffee-chats) with colleagues to reconnect, share experiences, and ease back into work relationships. In our all-remote environment, these connections require deliberate attention.
...
- If you are an interviewer, review your calendar to address any scheduled interviews. Please review this [handbook page](/handbook/hiring/interviewing/#tips-for-keeping-your-google-calendar-up-to-date) and work with the recruiter and CES partner to reschedule or find a replacement interviewer.

### Knowledge Transfer and Work Continuity

### Documentation and Iteration

- Document your knowledge and share it with others to help prevent [Key-person-risk](https://dynamicbusiness.com/locked/managing-key-person-risk.html). This is especially true for “subject matter experts” or SME, people with specialized knowledge of a project, tool, or subject.
...
Please see the [On-Call](/handbook/engineering/on-call/) page for information on how to handle scheduled leave for someone from the On-Call team.
...
1. Update your Slack and Google Calendar. If you have the Time Off by Deel integration this should occur automatically after entering your time into Workday. Note: the OOO event will not auto-decline your meetings.
1. Set an out-of-office automated Gmail response including your away dates and identify someone to contact in your absence.

### Types of Unplanned Time Away

Please click on each of the time-off types listed below for more information.

1. [Sick Time Policy](/handbook/people-group/time-off-and-absence/time-off-types/#sick-time)
1. [Bereavement Policy](/handbook/people-group/time-off-and-absence/time-off-types/#bereavement)
1. [Emergency Leave Policy](/handbook/people-group/time-off-and-absence/leave-types/#emergency-leave)
...
1. Develop communication strategy with the team member
1. Reassign or develop a coverage plan for the team member’s work as appropriate

For more information about manager’s responsibilities related to absence management, please visit the [Manager Toolkit for Absence](https://theloop.gitlab.com/site/5ea8f77b-a0c3-4983-ba40-1463a96d8e21/page/772afb15-974d-4798-a383-fd7b49ca724d)!
...
- More information is available on the [Team PTO Calendar handbook page](https://theloop.gitlab.com/site/4455aa7f-24d9-41f2-b940-467b54962e4d/page/0fa19bf4-fd6a-41b9-9316-c2dcf3add854).
...
1. Select "Who's Out?" from the Home section dropdown
1. Click "new search" to view absences by #channel, @usergroup, or @username

### Additional Manager Requirements

As a people manager, you may receive tasks through Workday. If you are going to be away from work for a prolonged period of time, you should set up a delegate in Workday to approve transactions during your absence. Please follow the instructions [here](https://docs.google.com/document/d/1EJLaFxD2WJbMXxuKkxJESBQ7gNDJ8ClQyJhbXiv2_VU/edit?tab=t.0), and remember to remove the delegate after returning to work!
...
If you have constructive feedback or recommendations related to Workday and Time Off by Deel, please submit it [here](https://gitlab.com/gitlab-com/people-group/people-tools-technology/general/-/issues/912#note_2138933391).
