...
- Watch for your Welcome Email from the Candidate Experience Specialist team with instructions for ordering your [laptop](/handbook/security/corporate/end-user-services/laptop-management/)
- Please note that your laptop will be locked and will only be unlocked on your official first day (start date). You will then be able to complete the necessary onboarding steps and relevant access per the below.
...
- **Team Members in certain countries**: Watch for communications from our external partners:
  - France, Germany, Singapore, UK, New Zealand, Australia, Ireland, Spain, India, Israel: Papaya
...
#### Accessibility & Accommodations Support

At GitLab, everyone belongs and everyone can contribute. As a new team member, we want to ensure you have the tools, accommodations, and support you need to thrive from day one. We're here to remove barriers and create an environment where you can bring your best self to work.

**[Global Accessibility and Accommodations Policy](/handbook/people-policies/#global-accessibility-and-accommodations-policy)**

**Note: To ensure proper support and avoid declined requests, any equipment beyond our standard offerings requires approval before purchasing.**

##### Technology & Equipment Setup

- **Standard Equipment**: All GitLab team members can access ergonomic equipment through an office budget stipend, and technology through our regular IT processes.
- **Accommodations & Adjustments**: Assistive technology or specialized equipment beyond standard offerings can be requested through our Team Member Relations (TMR) team (`teammemberrelations@gitlab.com`).
- **Device Configuration**: Our IT team can configure your laptop with standard accessibility settings, or work with TMR for specialized software setup.

**[Accessibility Tech Stack - Accessibility Technologies](/handbook/business-technology/entapps-documentation/application-accessibility/)**

##### Remote Work Environment

- **Standard Home Office Budget**: We provide a budget for standard ergonomic equipment available to all team members - work with your manager and IT for these standard items.
- **Individualized Accommodations**: Need specific environmental modifications or specialized equipment beyond standard offerings? Connect with the Team Member Relations team for individualized assessment, support, and pre-approval.

##### Accessible Communication

- **Meeting Accessibility**: Request live captioning, interpreters, or alternative formats through your manager or IT team
- **Documentation Access**: All materials follow our Learning Content Accessibility Guidelines - contact Diversity, Inclusion and Belonging (DIB) team if you need specific document formats. They can be contacted via the `#diversity_inclusion_and_belonging` Slack channel once you have started with us.

##### Your First Steps

- **Before Day 1**: If you need workplace accommodations or adjustments beyond standard equipment, connect with our Team Member Relations team (teammemberrelations@gitlab.com) for assistance.
- **Day 1-3**: Explore accessibility features in your GitLab tools (Slack, Zoom, Google Workspace).
- **First Week**: For standard ergonomic equipment, discuss with your manager and IT. For specialized accommodations, submit a request in HelpLab (internal system) for the Team Member Relations team.
- **Ongoing**: Use standard IT processes for standard equipment needs, and reach out to the Team Member Relations (TMR) team via HelpLab (internal system) to request ongoing accommodations and/or adjustments.

##### Support Network

- **IT & HelpLab**: Standard equipment requests and technical support are available to all team members.
- **Team Member Relations**: Individualized workplace accommodations, adjustments, and individualized support beyond standard offerings.
- **Diversity, Inclusion & Belonging (DIB) Team**: Policy questions and accessibility consultation via Slack.

##### Our Commitment

Accessing accommodations is part of creating an inclusive environment where everyone can contribute. We're committed to continuous improvement and removing barriers - reach out whenever you need support.
...
A: We recommend waiting until your start date, as you'll receive a virtual card with funds for equipment purchases. If you do make purchases before starting, email expenses@gitlab.com immediately, as these will count against your onboarding funds.
...
A: Absolutely! Just review our co-working space guidelines once you get started in the internal handbook before signing any agreements.

**Q: Does GitLab provide funds for home office equipment?**

A: Yes! All new team members receive $1,500 USD (or local equivalent) via a [virtual card](https://internal.gitlab.com/handbook/finance/expenses/#equipment) for office equipment purchases.
...
A: [Family & Friends Day](/handbook/company/family-and-friends-day/) is our company-wide day off. On these days, we close our virtual office, reschedule all meetings, and take a visible break to prioritize well-being. The schedule is available in our [handbook](/handbook/company/family-and-friends-day/).
