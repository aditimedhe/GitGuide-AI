...
For detailed instructions on setting up mobile access, including Okta Verify prerequisites, see our [Mobile Access Guide](https://docs.google.com/document/d/1LucZq30Jwy3HSfT35JVX5yJ9QsBOnJAY/edit).
...
You can review an up to date list of compliance trainings being assigned from LevelUp [here](https://docs.google.com/document/d/1IYpcpoOxKhQrnp9xH0k8eZB8MtdRJ1jh/edit).
...
3. **Follow the setup guide:** [LevelUp Mobile Access Guide](https://docs.google.com/document/d/1LucZq30Jwy3HSfT35JVX5yJ9QsBOnJAY/edit)
...
A: Yes! Download the Cornerstone mobile app (search "Cornerstone Galaxy" in your app store) and log in with your Okta credentials. You can check out the full [access guide here](https://docs.google.com/document/d/1LucZq30Jwy3HSfT35JVX5yJ9QsBOnJAY/edit).
...
A: The best place to check is your [System Transcript](https://levelup.csod.com/DeepLink/ProcessRedirect.aspx?module=transcript). Access it from the top navigation bar by choosing **More > System Transcript**. You can filter by content type or date range to find specific completions.
