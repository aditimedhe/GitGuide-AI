...
- Updating total rewards policies (e.g., benefits plan iterations)
...
1. **Assess Your Situation**: What phase are you in? How much time do you have? Who are your key stakeholders? What's your biggest risk?

2. **Create Your Essentials**: Draft your From→To→Because statement, list top 5 stakeholders, identify executive sponsor, choose communication channels

3. **Build Your Support**: Meet with sponsor, identify change champions, schedule stakeholder conversations, create feedback mechanisms

4. **Apply the Framework**: Use our 8-phase approach, implement BRIDGE communications, and iterate based on feedback
...
- Change Management Primer ([Slides](https://docs.google.com/presentation/d/1mEgpymla0iCgfYjA7Vesis3z8ANFBT_sVj7JEPlWv2Y/edit?usp=sharing)) ([Video](https://www.youtube.com/watch?v=Gz6OpHnOGlM&feature=youtu.be))
- [Change Management Toolkit](https://levelup.edcast.com/channel/change-management-hub/60631)
- [BRIDGE Framework](https://levelup.edcast.com/insights/quick-guide-bridge-framework)
- [Change Template](https://levelup.edcast.com/insights/change-template-leadership-organizational-general)
- [Change Management FAQ](https://levelup.edcast.com/insights/change-management-faq)
