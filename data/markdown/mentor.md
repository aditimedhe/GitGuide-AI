...
1. **Make yourself available as a mentor** by following these steps.
1. **Participate in an organized mentorship program** where mentors and mentees are paired based on an application process.
...
| **Respect Diverse Experiences** | Recognise that underrepresented groups might face additional barriers to advancement. Educate yourself and ask for advice and support via the [appropriate DIB channels](/handbook/company/culture/inclusion/tmrg-tmag/). |
